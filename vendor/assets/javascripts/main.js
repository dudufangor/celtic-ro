...
function (a) {
    ...
    var c = {
        widget: function (a) {
            return "var headroom = new Headroom(elem, " + JSON.stringify(a, null, "  ") + ");\nheadroom.init();\n\n" + "// to destroy\n" + "headroom.destroy();"
        },
        plugin: function (a) {
            return '$("header").headroom(' + JSON.stringify(a, null, "  ") + ");\n\n" + "// to destroy\n" + '$("#header").headroom("destroy");'
        },
        dataApi: function (a) {
    ...
    new b(a.querySelector("form"), new CodeGenerator(c), function (a) {
