...
ActiveRecord::Schema.define(version: 3) do
  ...
  add_index "atcommandlog", ["account_id"], name: "account_id", using: :btree
  add_index "atcommandlog", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "branchlog", ["account_id"], name: "account_id", using: :btree
  add_index "branchlog", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "cart_inventory", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "cashlog", ["type"], name: "type", using: :btree
  ...
  add_index "char", ["account_id"], name: "account_id", using: :btree
  add_index "char", ["guild_id"], name: "guild_id", using: :btree
  add_index "char", ["name"], name: "name_key", unique: true, using: :btree
  add_index "char", ["online"], name: "online", using: :btree
  add_index "char", ["party_id"], name: "party_id", using: :btree
  ...
  add_index "chatlog", ["src_accountid"], name: "src_accountid", using: :btree
  add_index "chatlog", ["src_charid"], name: "src_charid", using: :btree
  ...
  add_index "friends", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "global_reg_value", ["account_id"], name: "account_id", using: :btree
  ...
  add_index "guild", ["char_id"], name: "char_id", using: :btree
  add_index "guild", ["guild_id"], name: "guild_id", unique: true, using: :btree
  ...
  add_index "guild_alliance", ["alliance_id"], name: "alliance_id", using: :btree
  ...
  add_index "guild_castle", ["guild_id"], name: "guild_id", using: :btree
  ...
  add_index "guild_member", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "guild_storage", ["guild_id"], name: "guild_id", using: :btree
  ...
  add_index "inventory", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "ipbanlist", ["list"], name: "list", using: :btree
  ...
  add_index "login", ["userid"], name: "name", using: :btree
  ...
  add_index "loginlog", ["ip"], name: "ip", using: :btree
  ...
  add_index "mapreg", ["index"], name: "index", using: :btree
  add_index "mapreg", ["varname"], name: "varname", using: :btree
  ...
  add_index "memo", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "npclog", ["account_id"], name: "account_id", using: :btree
  add_index "npclog", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "picklog", ["type"], name: "type", using: :btree
  ...
  add_index "sc_data", ["account_id"], name: "account_id", using: :btree
  add_index "sc_data", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "skillcooldown", ["account_id"], name: "account_id", using: :btree
  add_index "skillcooldown", ["char_id"], name: "char_id", using: :btree
  ...
  add_index "storage", ["account_id"], name: "account_id", using: :btree
  ...
  add_index "zenylog", ["type"], name: "type", using: :btree
